...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, claude, codex, qwen, iflow, kimi, cursor.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "qwen", "iflow", "kimi", "cursor":
		return provider
	default:
		return ""
	}
